<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Payment_success.aspx.cs" Inherits="Payments_Payment_success" %>
...
<body id="pageone">
    <form id="form1" runat="server">
        <div>
            ...
            <nav class="navbar fixed-top navbar-light bg-light text-center">
                <a href="javascript:void(0);" id="StoreName" runat="server" class="navbar-brand" style="margin-left: 50px;">
                    <p style="font-size: 12px; color: #e6e6e6; text-align: left; margin-bottom: 0px; font-weight: 400;"></p>
                </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-md-8">
                            <div class="Paymentcard">
                                <h2 class="pay-title" style="font-size: 25px;" id="Status" runat="server"></h2>
                                <div class="row">
                                    <div class="col-12" style="text-align: center;" runat="server">
                                        <button type="button" class="btn btn-primary border-0 pull-right btnstyle" runat="server" style="display: none;" id="TryAgain">Try Again</button>
                                        <button type="button" class="btn btn-primary border-0 pull-right btnstyle" runat="server" style="display: none;" id="GoToHome">Go to Home</button>
                                        <button type="button" class="btn btn-primary border-0 pull-right btnstyle" runat="server" style="display: none;" id="MyOrders">My Orders</button>
                                    </div>
    ...
    <script>
        ...
        $('#GoToHome').click(function (e) {
            ...
            setCookie('orderconfirm', HeaderId, 50);
