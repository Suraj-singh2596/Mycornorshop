<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Payment_details.aspx.cs" Inherits="Payments_Payment_details" %>
...
<body id="pageone">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-md-8">
                            ...
                            <div class="Paymentcard">
                                <h2 class="pay-title mb-4">Payment Details</h2>

                                <div class="row">
                                    <div class="col-sm-1"></div>
                                    <div class="col-sm-10">
                                        <div class="detailbox card">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-8">
                                                <asp:Button ID="Button1" CssClass="btn btn-primary  border-0 pull-right btnstyle" runat="server" OnClick="Button1_Click" Text="Proceed" />
                                            </div>
                                        </div>
    ...
    <div class="cardatmcls atmcard">
        ...
        <div class="data">
            ...
            <div class="first-digits d-none"></div>
            <div class="container">
