<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeliveryBoy_Delivered_Orders.aspx.cs" Inherits="Components_DeliveryBoy_Delivered_Orders" %>
    ...
    <script>
        $('#view_more').click(function (e) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "DeliveryBoy_Delivered_Orders.aspx/getCustomerOrdersbydatesNextRecords",
        ...
        function All_Actions() {
            ...
            $(".show__itemsmore").click(function () {
                ...
                if ($.trim(current.parent().parent().parent().find(".items__append").html()).length == 0) {
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "DeliveryBoy_Delivered_Orders.aspx/getItemsByHeader",
                ...
                function payamountfunction(recievedamt, MOP, Header_ID) {
                    if (recievedamt == '0') {
                        ...
                        $.ajax({
                            type: "POST",
                            async: true,
                            url: "DeliveryBoy_Delivered_Orders.aspx/AmountReceived",
            ...
            function getDataByHeaderID(Header_ID, current) {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "DeliveryBoy_Delivered_Orders.aspx/getCustomerOrdersbydatesRefresh",
            ...
            $('.notifybtnshow').click(function (e) {
                ...
                var notifmodalD = '<div class="modal-dialog" role="document">' +
                    ...
                    '<div class="modal-footer border-0">' +
                    '<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>' +
                    '<a  href="javascript:void(0);" class="btn btnstyle notifycustbtn"   headerid="' + Header_ID + '">Notify Customer </a>' +
                    '</div></div ></div >';
                $("#notifymodal").empty();
                ...
                $(".notifycustbtn").click(function (e) {
                    ...
                    $.ajax({
                        type: "POST",
                        async: true,
                        url: "DeliveryBoy_Delivered_Orders.aspx/NotifyCustomer",
                        data: '{Header_ID:"' + Header_ID + '"}',
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",
                        success: function (data) {
        ...
        function getData(startdate, enddate) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "DeliveryBoy_Delivered_Orders.aspx/getCustomerOrdersbydates",
        ...
        function fnParticularItemCheckedUnchecked(Header_ID, Line_ID, Flag, Order_No) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "DeliveryBoy_Delivered_Orders.aspx/MarkDelivered",
        ...
        function todaysCollection() {
            $.ajax({
                type: "POST",
                async: true,
                url: "DeliveryBoy_Delivered_Orders.aspx/todaysCollection",
                data: '{}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (data) {
        ...
        $("#Notif_seenBtn").click(function (e) {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "DeliveryBoy_Delivered_Orders.aspx/Fn_updateSeenFlag",
                data: '{}',
                beforeSend: function () {
                    $("#preload").show();
                },
