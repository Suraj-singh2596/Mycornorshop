<%@ Page Language="C#" AutoEventWireup="true" CodeFile="recurring_orders.aspx.cs" Inherits="Components_recurring_orders" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <nav class="navbar fixed-top navbar-light bg-light text-center">
                <a class="navbar-brand" href="javascript:void(0);" id="StoreName" runat="server" style="margin-left: 40px;">My Subscriptions
    ...
    <script>
        ...
        $('#view_more').click(function (e) {
            ...
            $.ajax({
                ...
                dataType: "json",
                url: "recurring_orders.aspx/Fn_getSchedulardataNextRecords",
                data: "{}",
        ...
        function getSchedulerdata() {
            ...
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                url: "recurring_orders.aspx/Fn_getSchedulardata",
                data: "{}",
                success: function (data) {
                    if (data.d != '') {
        ...
        function Subscription_Actions() {
            ...
            $('.modify_subscription').click(function (e) {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    url: "recurring_orders.aspx/EditItem",
        ...
        function Delete_action_taken(line_id, Flag) {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                url: "recurring_orders.aspx/Fn_Deletesubscription",
