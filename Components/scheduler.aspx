<%@ Page Language="C#" AutoEventWireup="true" CodeFile="scheduler.aspx.cs" Inherits="Components_scheduler" %>
...
<body id="pageone">
    <form id="form1" runat="server">
        <div>
            ...
            <nav class="navbar fixed-top navbar-light bg-light text-center">
                <a class="navbar-brand" href="javascript:void(0);" id="StoreName" runat="server" style="margin-left: 40px;">Order
    ...
    <script src="../jquery-helper/Main.js"></script>
    <script src="../jquery-helper/DpHelper.js"></script>
    <script>
        $('#view_more').click(function (e) {
            ...
            $.ajax({
                type: "POST",
                async: true,
                url: "scheduler.aspx/getCustomerOrderByDateNextRecords",
        ...
        function getData(startdate, enddate) {
            $.ajax({
                type: "POST",
                async: true,
                url: "scheduler.aspx/getCustomerOrderByDate",
        ...
        function All_Actions() {
            ...
            $(".show__itemsmore").each(function () {
                ...
                $.ajax({
                    type: "POST",
                    async: true,
                    url: "scheduler.aspx/getItemsByHeader",
            ...
            $('.onlinePay2').click(function (e) {
                ...
                $.ajax({
                    ...
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    url: "../Components/scheduler.aspx/GenerateTrxID",
        ...
        function cancelOrder(Header_ID) {
            $.ajax({
                ...
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                url: "../Components/scheduler.aspx/DeleteOrder",
                data: "{'Header_ID':'" + Header_ID + "'}",
                success: function (data) {
