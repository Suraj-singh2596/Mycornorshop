<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Account_receivable.aspx.cs" Inherits="Components_Account_receivable" %>
...
<div class="side-menu">
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <nav class="navbar fixed-top navbar-light bg-light text-center">
                <a href="javascript:void(0);" id="StoreName" runat="server" class="navbar-brand" style="margin-left: 30px;">Account Receivable
            ...
            <section style="margin-top: 90px;">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-md-8" id="Notifications" style="padding-bottom:100px;">
    ...
    <div class="cardatmcls atmcard">
        ...
        <div class="data">
            ...
            <div class="first-digits d-none">0</div>
            <div class="container">
    ...
    <script>
        ...
        function GetReceiveableDetails() {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Account_receivable.aspx/Fn_all_trxhistory_rid",
                data: '{}',
                beforeSend: function () {
                ...
                success: function (data) {
                                $("#Notifications").empty();
                    $("#Notifications").append(data.d);
                    $('.sendpaymentlinkbtn').click(function (e) {
                        var Amount = $.trim($(this).parent().find('.LinkAmount').val());
                        ...
                        if (parseFloat(Amount) < 0) {
                            ...
                            sendPaymentLink(Mobile, Amount, 'Y', CID);
        ...
        function sendPaymentLink(Mobile, Amount, Flag, CID) {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Account_receivable.aspx/sendPaymentLink",
                ...
                dataType: "json",
                success: function (data) {
                    showpopup('Link sent successfully');
                },
                complete: function () {
