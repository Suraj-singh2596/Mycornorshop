<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Notifications.aspx.cs" Inherits="Components_Notifications" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <nav class="navbar fixed-top navbar-light bg-light text-center">
                <a href="javascript:void(0);" id="StoreName" runat="server" class="navbar-brand" style="margin-left: 40px;">Notifications
            ...
            <section style="margin-top: 90px;">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-md-8" runat="server" id="Notifications">
    ...
    <script>
        ...
        function fnredirectbtn(current) {
            var linkis = current.attr('redirectto');
            if (linkis != "" || linkis != undefined) {
                location.href = linkis;
            }
