...
public partial class Components_Delivery : System.Web.UI.Page
{
    ...
    public static string getCustomerOrdersbydatesRefresh(string Header_ID, string Flag)
    {
        DataSet ds = new DataSet();
        cl_resturant cr = new cl_resturant();
        cr.RID = HttpContext.Current.Request.Cookies["rid"].Value.ToString();
        ...
        if (Flag == "Y")
        {
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[1].Rows.Count > 0)
            {
                ...
                insertNotification(HttpContext.Current.Request.Cookies["admin_user_id"].Value.ToString(), ds.Tables[1].Rows[0]["USER_ID"].ToString()
                    , Title, Message, "Customer");
                Send_Notification.SendNotificationFromFirebaseCloud(HttpContext.Current.Request.Cookies["rid"].Value.ToString(),
                    ds.Tables[1].Rows[0]["DEVICE_ID"].ToString(), "https://mycornershop.in/Components/scheduler.aspx", Title, Message, 1);
            }
        }
    ...
    [WebMethod]
    public static string NotifyCustomer123(string Header_ID)
    {
    ...
    public static string UpdateNotifyFlag(string Header_ID)
    {
        DataSet ds = new DataSet();
        cl_resturant cr = new cl_resturant();
        cr.RID = HttpContext.Current.Request.Cookies["rid"].Value.ToString();
