<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Custom_notification.aspx.cs" Inherits="Components_Custom_notification" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <nav class="navbar fixed-top navbar-light bg-light text-center">
                <a href="javascript:void(0);" id="StoreName" runat="server" class="navbar-brand" style="margin-left: 40px;">Send Custom Notifications
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-md-8">
                            ...
                            <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                <label class="control-label">Message in Descriptions</label>
                                <textarea  class="form-control"></textarea>
                            </div>

                           <div class="form-group pmd-textfield pmd-textfield-floating-label">
                                
                                <button type="button" id="SendNotifBtn" class="btn btnstyle w-100">Notify all my customers</button>
                            </div>
                            </div>
    ...
    <script>
        ...
        function ConfirmDialogNotif() {
            $('<div></div>').appendTo('body')
                .html('<div><h6>Are you sure that you want to notify all of your customers (480 customers)?</h6></div>').dialog({
                    modal: true,
                    title: 'Confirm',
                    zIndex: 10000,
                    autoOpen: true,
