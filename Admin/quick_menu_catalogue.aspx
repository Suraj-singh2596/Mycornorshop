<%@ Page Language="C#" AutoEventWireup="true" CodeFile="quick_menu_catalogue.aspx.cs" Inherits="Admin_quick_menu_catalogue" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Quick Menu Catalogue</title>
    ...
    <script>
        ...
        function getCategoryNames() {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "quick_menu_catalogue.aspx/getCategoryNames",
                data: '{}',
                dataType: "json",
                success: function (data) {
                    if (data.d != '') {
        ...
        function getListByCGName(CG_Name) {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "quick_menu_catalogue.aspx/getListByCGName",
        ...
        function getMenuBymid(mid, flag, p, Table_Name) {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "quick_menu_catalogue.aspx/Getmenubymid",
        ...
        function fnActionTaken(Flag, MID, p, Table_Name, Item_Name, Comment, Price, MRP, Local_Name, Barcode) {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "quick_menu_catalogue.aspx/fnActionTaken",
        ...
        function getListByCGNamerRetailer(CG_Name) {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "quick_menu_catalogue.aspx/getListByCGNamerRetailer",
                data: '{CG_Name: "' + CG_Name + '"}',
                dataType: "json",
                success: function (data) {
                    if (data.d != '') {
        ...
        function searchGeneralList(Search_Value) {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "quick_menu_catalogue.aspx/searchGeneralList",
        ...
        function searchRetailerList(Search_Value) {
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "quick_menu_catalogue.aspx/searchRetailerList",
                data: '{search: "' + Search_Value + '"}',
                dataType: "json",
                success: function (data) {
                    if (data.d != '') {
